...
# we'll get the latest version instead of that old version..
wget https://repo.anaconda.com/archive/Anaconda3-2020.07-Linux-x86_64.sh -O /home/ec2-user/anaconda.sh &&
